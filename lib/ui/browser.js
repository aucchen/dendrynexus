...
(function($) {
  ...
  BrowserUserInterface.prototype.displayHand = function(hand, maxCards) {
    // display the hand
    var $handEl = $('<ul>').addClass('hand');
    // TODO: display blank spaces for cards
  ...
  BrowserUserInterface.prototype.displayDecks = function(decks) {
    ...
    for (var deck of decks) {
      ...
      if (deck.image) {
        ...
        // TODO: set alternative background for 4deckLink to a gradient
      }
  ...
  BrowserUserInterface.prototype._registerEvents = function() {
    ...
    this.$content.on('click', 'ul.decks li', function(event) {
      event.preventDefault();
      event.stopPropagation();
