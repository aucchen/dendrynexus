...
(function($) {
  ...
  BrowserUserInterface.prototype.displayHand = function(hand) {
    // display the hand
  ...
  BrowserUserInterface.prototype.displayDecks = function(decks) {
    ...
    for (var deck of decks) {
      ...
      var $deckImage = $('<img>');
      var $title = $('<span>').text(deck.title);
      $deckEl.append($deckImage);
      $deckEl.append($title);
  ...
  BrowserUserInterface.prototype._registerEvents = function() {
    ...
    // TODO: onclick for decks and cards
    this.$content.on('click', '.deck', function(event) {
    });
  };
