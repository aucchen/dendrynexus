...
(function($) {
  ...
  BrowserUserInterface.prototype.displayGameOver = function() {
    var $p = $('<p id="content_fade_in fade_out">').text(this.getGameOverMsg()).addClass('game-over');
    this.$content.append($p);
  };
  BrowserUserInterface.prototype.displayChoices = function(choices) {
    var $ul = $('<ul id="content_fade_in fade_out">').addClass('choices');
  ...
  BrowserUserInterface.prototype.newPage = function() {
    // TODO: I want to do some animation here but because of the asynchronous
    // nature of js, it's impossible.
    this.$content.empty();
