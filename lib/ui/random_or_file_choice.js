...
(function() {
    ...
    var RandomTest = function(game, consoleObj, width, textDumpFile, scriptDumpFile, stateDumpFile, inputScript) {
        this.game = game;
        this.console = consoleObj || console;
        this.defaultWidth = width || 80;

        // dump all game text
        this.textDumpFile = textDumpFile || 'text.txt';
        // dump choice text
        this.scriptDumpFile = scriptDumpFile || 'script.txt';
        // dump game state at the end of the game
        this.stateDumpFile = stateDumpFile || 'state.json';
        this.inputScript = inputScript || null;

        // TODO: open file streams for the dump files?
    ...
    // TODO
    RandomTest.prototype._dumpAndQuit = function() {
