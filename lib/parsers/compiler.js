...
(function() {
  ...
  Game.prototype._fullyQualityIdsInSetJump = function(scene) {
  ...
  Game.prototype._fullyQualifyIdsInScene = function(scene, callback) {
    ...
    this._fullyQualityIdsInSetJump(scene);
  ...
  var compileGame = function(sourceDir, callback) {
    var info;
    // TODO: prevScene is a special scene that is always accessible and blank.
    ...
    var backSpecialScene = {id: 'backSpecialScene',
                            content: {content: '', type: 'paragraph'}};
    var scenes = [prevScene, prevTopScene, jumpScene, backSpecialScene];
    var qualities = [];
    var qdisplays = [];
