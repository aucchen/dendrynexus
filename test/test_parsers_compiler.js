  ...
  describe('game compiler', function() {
    ...
    describe('id resolution', function() {
      ...
      _.each(ok, function(case_) {
        ...
        it('should resolve "' + id + '" in "' + context +
           '" to ' + order.join(', '),
           function() {
      ...
      _.each(fail, function(case_) {
        var id = case_.id;
        var context = case_.context;
        it('should fail to resolve "' + id + '" in "' + context + '"',
           function() {
          (function() {
    ...
    describe('id modification', function() {
      ...
      it('should fail if an option and scene have no title', function(done) {
        ...
        compiler.compile(info, scenes, qualities, qdisps, function(err, game) {
          (!!err).should.be.true;
          err.message.should.equal(
            'Option refers to scene "two", but neither ' +
      ...
      it('should fail for non matching id in on-arrival', function(done) {
        var fn = function(state, Q) {
      ...
      it('should fail for non matching id in content', function(done) {
        var fn = function(state, Q) {
      ...
      it('should fail for non matching id in view-if', function(done) {
        var fn = function(state, Q) {
